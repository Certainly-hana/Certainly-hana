...
function createtime1() {
  ...
  var ascll = [
    ...
    _____  _           _____ _                            
    |  __ \(_)         / ____| |                           
    | |__) |_  ___ ___| (___ | |__   _____      _____ _ __ 
    |  _  /| |/ __/ _ \\___ \| '_ \ / _ \ \ /\ / / _ \ '__|
    | | \ \| | (_|  __/____) | | | | (_) \ V  V /  __/ |   
    |_|  \_\_|\___\___|_____/|_| |_|\___/ \_/\_/ \___|_|   
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问Certainly的小站",
...
function createtime() {
  ...
  var start = new Date("03/03/2018 00:00:00"); // 旅行者1号开始计算的时间
